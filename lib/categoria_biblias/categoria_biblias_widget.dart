...
import 'categoria_biblias_model.dart';
export 'categoria_biblias_model.dart';

class CategoriaBibliasWidget extends StatefulWidget {
  const CategoriaBibliasWidget({super.key});

  @override
  State<CategoriaBibliasWidget> createState() => _CategoriaBibliasWidgetState();
}

class _CategoriaBibliasWidgetState extends State<CategoriaBibliasWidget>
    with TickerProviderStateMixin {
  late CategoriaBibliasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategoriaBibliasModel());
                                    ...
                                    children: [
                                      FlutterFlowChoiceChips(
                                        options: [
                                          ...
                                          ChipData('JER'),
                                          ChipData('LAT'),
                                          ChipData('Otros Idiomas'),
                                          ChipData('Bilingue'),
                                          ChipData('Peshita'),
                                          ChipData('Especiales'),
                                          ChipData('Otras Versiones')
                                        ],
                                      ...
                                      children: [
                                        FlutterFlowChoiceChips(
                                          options: [
                                            ChipData('Grande'),
                                            ChipData('Gigante'),
                                            ChipData('Super Gigante'),
                                            ChipData('Mediana'),
                                            ChipData('Chica'),
                                            ChipData('Super Chica')
                                          ],
                                          onChanged: (val) => setState(() =>
