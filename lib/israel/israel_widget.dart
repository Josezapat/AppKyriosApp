...
import 'israel_model.dart';
export 'israel_model.dart';

class IsraelWidget extends StatefulWidget {
  const IsraelWidget({super.key});

  @override
  State<IsraelWidget> createState() => _IsraelWidgetState();
}

class _IsraelWidgetState extends State<IsraelWidget> {
  late IsraelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IsraelModel());
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowChoiceChips(
                              options: [
                                ChipData('Menorah'),
                                ChipData('Llaveros Israel'),
                                ChipData('Tallit'),
                                ChipData('Aceites'),
                                ChipData('Kippah'),
                                ChipData('Banderas'),
                                ChipData('Especial Israel')
                              ],
