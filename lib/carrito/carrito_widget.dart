  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CartRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CartRecord> carritoCartRecordList = snapshot.data!;
        final carritoCartRecord = carritoCartRecordList.isNotEmpty
            ? carritoCartRecordList.first
            : null;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final itemsSeleccionados = carritoCartRecord
                                      ?.selectedItemsList
                                      ?.toList() ??
                                  [];
                              return ListView.builder(
                                ...
                                itemBuilder:
                                  ...
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        16.0, 0.0, 16.0, 8.0),
                                    child: StreamBuilder<SelectedItemsRecord>(
                                      stream: SelectedItemsRecord.getDocument(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          ...
                                                          if (confirmDialogResponse) {
                                                            ...
                                                            await menuItemSelectedItemsRecord
                                                                .reference
                                                                .delete();
                                                          }
                                                          if (carritoCartRecord
                                                                  ?.selectedItemsList
                                                                  ?.length ==
                                                              0) {
                                                            context.pushNamed(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          if (carritoCartRecord?.selectedItemsList?.length
                                  .toString() ==
                              '0') {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Debes agregar productos a tu Carrito',
                                  style: TextStyle(
                                    color: FlutterFlowTheme.of(context)
                                        .primaryText,
                                  ),
                            ...
                            context.pushNamed('PasareladePago');
                          }
                        },
                        text: 'ir a Pagar',
